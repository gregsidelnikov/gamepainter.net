<?php include('../Migration/Composition.php');
    ...
    if ($LOCALHOST) { } else {
        ...
        //if ($BLACK_SHEEP_IP != $_SERVER["REMOTE_ADDR"])
          //  exit;
    }

    $Connection = new db();
    $Article    = db::get("content", "*", "", "", "1"); // test article
    $divs   = db::get("divs", "*", "", "`index` ASC");
...
<div id = "NavControls">
    <div style = "background: #435481;">
        <div class = "option"><a href = "#" onclick = "to_admin(); $('#Admin').show().end().add('#Editor').hide();">Admin</a></div>
        <div class = "option"><a href = "#" onclick = "to_editor(); $('#Admin').hide().end().add('#Editor').show();">Editor</a></div>
        <div class = "option"><a href = "<?php print $URL; ?>/admin/builder.php" target = "_blank" style = "">Builder</a></div>
        <div class = "option"><a href = "<?php print $URL; ?>/plugins/list/view/" target = "_blank" style = "">List</a></div>
...
Welcome to your <?php print $URL; ?> control panel. Click "Editor" to manage page content.
...
<?php /*
        ...
        */ ?>
        ...
        <div id = "DocumentControls" style = "margin-top: 8px; text-align: center;">
            ...
            <a onclick = "hyperlink()" href = "#" class = "ctrl_btn" id = "ctrl_hyperlink"><img src = "hyperlink.png" alt = "Insert Hyperlink" /></a>
            <a onclick = "bold()" href = "#" class = "ctrl_btn" id = "ctrl_bold"><img src = "bold.png" alt = "Make Bold" /></a>
            <a onclick = "italic()" href = "#" class = "ctrl_btn" id = "ctrl_italic"><img src = "italic.png" alt = "Make Italic" /></a>
            <a onclick = "photo()" href = "#" class = "ctrl_photo" id = "ctrl_photo"><img src = "photo.png" alt = "Insert Photo" /></a>
            <a onclick = "grid(2)" href = "#" class = "ctrl_grid" id = "ctrl_grid"><img src = "grid.png" alt = "Insert Grid Layout" /></a>
            <a onclick = "grid(25)" href = "#" class = "ctrl_grid" id = "ctrl_grid"><img src = "grid-m.png" alt = "Insert Grid Layout With Middle Separator" /></a>
            <a onclick = "grid(3)" href = "#" class = "ctrl_grid" id = "ctrl_grid"><img src = "grid3.png" alt = "Insert Grid Layout" /></a>
